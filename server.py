...
SCRIPTS = [
    # 0 - Web/URL Filter
    {
        ...
        "targets": [
            ...
            {"key": "https://www.pornhub.com",         "label": "Pornhub (Adult)", "defaultOff": True},
            {"key": "https://www.xvideos.com",         "label": "XVideos (Adult)", "defaultOff": True},
    ...
    # 1 - IDPS
    {
        ...
        "targets": [
            ...
            {"key": "malware-vault-dns", "label": "Malware Vault DNS"},
            {"key": "malc0de-dns",     "label": "Malc0de DNS"},
            {"key": "malware-bazaar-dns", "label": "MalwareBazaar DNS"},
    ...
    # 2 - URL Reputation
    {
        ...
        "name": "URL Reputation",
        "targets": [
            {"key": "safebrowsing-malware", "label": "Google Safe Browsing Malware Test", "level": "High Risk"},
            {"key": "safebrowsing-phish",   "label": "Google Safe Browsing Phishing Test", "level": "High Risk"},
            {"key": "wicar-malware",        "label": "WICAR Malware Test File", "level": "High Risk"},
            {"key": "wicar-cryptominer",    "label": "WICAR Cryptominer Page", "level": "High Risk"},
            {"key": "mcafee-highrisk",      "label": "McAfee High Risk Test", "level": "High Risk"},
            {"key": "mcafee-red",           "label": "McAfee Red Verdict Test", "level": "High Risk"},
            {"key": "mcafee-gray",          "label": "McAfee Unverified/Gray Test", "level": "Suspicious"},
            {"key": "mcafee-yellow",        "label": "McAfee Medium/Yellow Test", "level": "Moderate Risk"},
            {"key": "amtso-phishing",       "label": "AMTSO Phishing Test Page", "level": "Trustworthy"},
            {"key": "amtso-pua",            "label": "AMTSO PUA Test Page", "level": "Trustworthy"},
            {"key": "wicar-site",           "label": "WICAR Test Site", "level": "Trustworthy"},
            {"key": "amtso-site",           "label": "AMTSO Security Org", "level": "Trustworthy"},
            {"key": "google",              "label": "Google (control)", "level": "Trustworthy"},
            {"key": "microsoft",           "label": "Microsoft (control)", "level": "Trustworthy"},
        ],
    },
    # 3 - IP Reputation
    {
        ...
        "name": "IP Reputation",
        "targets": [
            {"key": "185.220.101.1",   "label": "Tor Exit - CCC"},
            {"key": "23.129.64.130",   "label": "Tor Exit - Emerald Onion"},
            {"key": "171.25.193.25",   "label": "Tor Exit - DFRI"},
            {"key": "89.234.157.254",  "label": "Tor Exit - marylou"},
            {"key": "209.141.55.26",   "label": "Bulletproof Host"},
            {"key": "192.42.116.16",   "label": "Tor Directory Auth"},
