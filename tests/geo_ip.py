...
PRESETS = [
    ...
    ("DE", "Germany (DE)", "https://www.bundesregierung.de"),
    ("JP", "Japan (JP)", "https://www.japan.go.jp"),
    ("IN", "India (IN)", "https://www.india.gov.in"),
    ("GB", "United Kingdom (GB)", "https://www.gov.uk"),
    ("FR", "France (FR)", "https://www.gouvernement.fr"),
    ("IT", "Italy (IT)", "https://www.governo.it"),
    ("BR", "Brazil (BR)", "https://www.gov.br"),
    ("RU", "Russia (RU)", "https://mid.ru/en"),
    ("KR", "South Korea (KR)", "https://www.korea.net/main"),
    ...
    ("NL", "Netherlands (NL)", "https://www.government.nl"),
    ("SA", "Saudi Arabia (SA)", "https://www.my.gov.sa"),
    ("TR", "Turkey (TR)", "https://www.turkiye.gov.tr"),
    ("CH", "Switzerland (CH)", "https://www.admin.ch"),
    ...
    ("NO", "Norway (NO)", "https://www.regjeringen.no"),
    ("IL", "Israel (IL)", "https://www.gov.il"),
    ("IE", "Ireland (IE)", "https://www.gov.ie"),
    ("NG", "Nigeria (NG)", "https://services.gov.ng"),
    ...
    ("PH", "Philippines (PH)", "https://www.gov.ph"),
    ("BD", "Bangladesh (BD)", "https://www.bangladesh.gov.bd"),
    ("EG", "Egypt (EG)", "https://www.presidency.eg/en"),
    ("VN", "Vietnam (VN)", "https://en.baochinhphu.vn"),
    ("TH", "Thailand (TH)", "https://www.thaigov.go.th"),
    ("AT", "Austria (AT)", "https://www.oesterreich.gv.at"),
    ("CL", "Chile (CL)", "https://www.gob.cl"),
    ("CZ", "Czech Republic (CZ)", "https://www.vlada.cz"),
    ("FI", "Finland (FI)", "https://www.government.fi"),
    ("PT", "Portugal (PT)", "https://www.portugal.gov.pt"),
    ("NZ", "New Zealand (NZ)", "https://www.govt.nz"),
    ("GR", "Greece (GR)", "https://www.primeminister.gr"),
    ("PE", "Peru (PE)", "https://www.gob.pe"),
    ("CO", "Colombia (CO)", "https://www.gov.co"),
    ("KZ", "Kazakhstan (KZ)", "https://www.gov.kz"),
    ("IQ", "Iraq (IQ)", "https://www.cabinet.iq"),
    ("DZ", "Algeria (DZ)", "https://www.premier-ministre.gov.dz"),
    ("QA", "Qatar (QA)", "https://www.hukoomi.gov.qa"),
    ("HU", "Hungary (HU)", "https://www.kormany.hu"),
    ("KW", "Kuwait (KW)", "https://www.e.gov.kw"),
    ...
    ("GT", "Guatemala (GT)", "https://www.guatemala.gob.gt"),
    ...
    ("LT", "Lithuania (LT)", "https://www.lrv.lt"),
    ...
    ("PG", "Papua New Guinea (PG)", "https://www.pm.gov.pg"),
    ("MM", "Myanmar (MM)", "https://www.myanmar.gov.mm/en"),
