...
SCRIPTS = [
    ...
    # 2 - URL Reputation
    {
        ...
        "targets": [
            ...
            {"key": "amtso-phishing",       "label": "AMTSO Phishing Test Page", "level": "Suspicious"},
            {"key": "amtso-pua",            "label": "AMTSO PUA Test Page", "level": "Suspicious"},
            {"key": "mcafee-gray",          "label": "McAfee Unverified/Gray Test", "level": "Suspicious"},
            {"key": "wicar-site",           "label": "WICAR Test Site", "level": "Moderate Risk"},
            {"key": "mcafee-yellow",        "label": "McAfee Medium/Yellow Test", "level": "Moderate Risk"},
            {"key": "amtso-site",           "label": "AMTSO Security Org", "level": "Low Risk"},
